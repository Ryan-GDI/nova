// May — backend server (v2: documents, images, OCR, reply drafting)
// Holds your secret API key and talks to Anthropic on May's behalf.
...
// Extract plain text from an uploaded .docx so May can read Word documents.
